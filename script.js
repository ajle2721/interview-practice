document.addEventListener('DOMContentLoaded', () => {
    ...
    if ('webkitSpeechRecognition' in window || 'SpeechRecognition' in window) {
        ...
        recognition.lang = 'en-US'; // Default, will change based on speech but mostly works for both if set to auto-detecting environment
    } else {
    ...
    function toggleRecording(user, btn) {
        ...
        recognition.lang = detectLanguagePreference(); // Try to be smart
        recognition.start();
        ...
        recognition.onresult = (event) => {
            ...
            // Auto-append to textarea if final
            if (finalTranscript) {
        ...
        recognition.onend = () => {
            ...
            btn.textContent = '🎤';
            // Keep preview visible for a moment then hide if empty
            if (!preview.textContent || preview.textContent === 'Listening...') {
